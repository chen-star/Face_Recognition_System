...
public class StartApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // student default photo
        Image img = new Image("file:/Users/chenjiaxin/Desktop/cmu1/java/team/teamProj/src/teamproj/photos/default.jpg", 400, 600, true, true);
        ImageView defaultImg = new ImageView(img);
        // student information
        Text studentInfoText = new Text("  Student infomation will be shown here!!");
        box.getChildren().addAll(t, defaultImg, new CustomPane(studentInfoText));
